...
function loadPhotos(page){
	...
	// --------------- Replace photo ids with the call to server that retrieve list of photos thats in the collection of the user ---------
	var photoids = ['zCjxIfeX7rg', 'GSVhYfuT6kc', 'cjl9C3cefCw', 'oK4bUk7ArxI'];
	var k = 0;
